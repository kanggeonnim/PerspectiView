...
import emptyImg from "@/assets/Empty_Empty.png"
    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="w-7/12 p-4 h-2/3">
        <div className="box-border p-3 h-1/6">
          <h1 className="flex items-start justify-start text-3xl font-semibold" >
            인물 정보 작성 
          </h1>
        </div>
        ...
        <div className="border-t-2 h-1/6">
          <h3 className="m-2 font-semibold text-md">
            인물이 등장한 스토리
          </h3>
        ...
        <CardFooter className="flex flex-row items-end justify-end gap-3 items h-1/6">
          <Button className="box-border flex w-1/4 md:w-1/6 sm:text-xs md:text-sm lg:text-base" variant="gray">
            취소하기
          </Button>
          <Button className="box-border flex w-1/4 md:w-1/6 sm:text-xs md:text-sm lg:text-base" variant="indigo">
            등록하기
          </Button>
        </CardFooter>
      </Card>
