        ...
        <header className="bg-white">
          ...
          >
            ...
            <div className="flex items-center lg:flex-1">
              ...
              <h1 className="text-3xl font-black text-primary-foreground">시:작</h1>
            </div>
            ...
            <div className="flex items-center justify-end">
              ...
              <Button
                variant="default"
                className="ml-4 text-sm font-semibold leading-6 text-slate-50 hover:bg-primary-foreground"
              >
                로그인
              </Button>
            </div>
